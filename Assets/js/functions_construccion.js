...
document.addEventListener('DOMContentLoaded', function(){
    ...
    tableConstruccion = $('#tableConstruccion').dataTable( {
        ...
        "ajax":{
            ...
            "url": " "+base_url+"/construccion/getLeads",
...
function fntViewInfo(iddatos){
    ...
    let ajaxUrl = base_url+'/construccion/getDatos/'+iddatos;
    ...
    request.onreadystatechange = function(){
        ...
        if(request.readyState == 4 && request.status == 200){
...

            {
                ...
                $('#modalViewConstruccion').modal('show');
...
function fntEditLead(element,idlead){
    ...
    let ajaxUrl = base_url+'/construccion/getDatos/'+idlead;
...
function startStatus(idlead){
    ...
    swal({
        ...
        if (willDelete) {
            ...
            var ajaxUrl = base_url + 'construccion/startConstruccion/';
...
function canalizarStatus(idlead){
    ...
    swal({
        ...
        successMode: true,
            ...
            var ajaxUrl = base_url + 'construccion/canalizarConstruccion/';
...
function atenderStatus(idlead){
    ...
    swal({
        ...
        successMode: true,
            ...
            var ajaxUrl = base_url + 'construccion/atenderConstruccion/';
...
function demoStatus(idlead){
    ...
    swal({
        ...
        successMode: true,
            ...
            var ajaxUrl = base_url + 'construccion/demoConstruccion/';
...
function cotizarStatus(idlead){
    ...
    swal({
        ...
        successMode: true,
            ...
            var ajaxUrl = base_url + 'construccion/cotizarConstruccion/';
...
function comprarStatus(idlead){
    ...
    swal({
        ...
        successMode: true,
            ...
            var ajaxUrl = base_url + 'construccion/comprarConstruccion/';
