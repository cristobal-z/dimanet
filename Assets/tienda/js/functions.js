...
function guardar(e){
    ...
    $.ajax({
        url: "../../../Controllers/usuario.php?op=guardarcorreo",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
		success: function(data){
            ...
            if (data==1){
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'Dimasur',
                    text : 'Gracias, una asesor se pondrá en contacto contigo!',
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Dimasur',
                    text : 'Su solicitud no pudo ser procesada, estamos trabajando para solucionarlo',
                    showConfirmButton: false,
                    timer: 2000
                })
            }
...
function nuevo(){
	const maquina = document.querySelector('#usu_maquina');
    $('#lbltitulo').html("Llena el formulario para obtener una cotización");
