...
class DjiModel extends Mysql{
	...
	public function insertUsuario(string $maquina,string $nombre, string $ciudad, string $telefono, string $email, string $cultivo, string $hectareas, string $canal, string $vendedor, string $comentarios){
...

			{
				...
				$query_insert  = "INSERT INTO tm_usuario(usu_maq,usu_nom,usu_city,usu_num,usu_correo,usu_cultivo,usu_hec, landing_page, usu_vendedor, usu_cmt, fech_crea, est)
	...
	public function updateUsuario(int $idUsuario,string $maquina, string $nombre, string $ciudad, string $telefono, string $email, string $cultivo, string $hectareas, string $canal, string $vendedor, string $comentarios){
...

			{
				...
				$sql = "UPDATE tm_usuario SET usu_maq = ?,usu_nom=?, usu_city=?, usu_num=?, usu_correo=?, usu_cultivo=?, usu_hec=?, landing_page=?, usu_vendedor=?, usu_cmt=? 
