<?php headerAdmin($data); ?>
    <main class="app-content">
      ...
      <div class="row">
        ...
        <?php if(!empty($_SESSION['permisos'][3]['r'])){ ?>
        <div class="col-md-6 col-lg-3">
          <a href="<?= base_url() ?>/leads" class="linkw">
            <div class="widget-small bg-primary coloured-icon"><i class="icon fa fa-user fa-3x"></i>
              <div class="info">
                <h4>Leads Dji</h4>
                <p><b><?= $data['dji'] ?></b></p>
              </div>
        ...
        <div class="col-md-6 col-lg-3">
          <a href="<?= base_url() ?>/productos" class="linkw">
            <div class="widget-small warning coloured-icon"><i class="icon fa fa fa-archive fa-3x"></i>
              <div class="info">
                <h4>Leads construcción</h4>
                <p><b><?= $data['construccion'] ?></b></p>
              </div>
            </div>
          </a>
        </div>
        ...
        <div class="col-md-6 col-lg-3">
          <a href="<?= base_url() ?>/pedidos" class="linkw">
            <div class="widget-small info coloured-icon"><i class="icon fa fa-shopping-cart fa-3x"></i>
              <div class="info">
                <h4>Leads agricola</h4>
                <p><b><?= $data['agricola'] ?></b></p>
              </div>
            </div>
          </a>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">Últimas cotizaciones</h3>
            <table class="table table-striped table-sm">
              ...
              <tbody>
                ...
                <tr>
                  <td><?= $pedido['usu_id'] ?></td>
                  <td><?= $pedido['nombre'] ?></td>
                  <td><?php if($pedido['est'] == 1){
                      echo "Atendido";
                    }else if($pedido['est'] == 0) {
                      echo "Canalizado";
                    }else if($pedido['est'] == 2){
                      echo "No viable";
                    }else if($pedido['est'] == 3) {
                      echo "Atendido";
                    }else if($pedido['est'] == 4){
                      echo "En demostración";
                    }else if($pedido['est'] == 5){
                      echo "No compró";
                    }else if($pedido['est'] == 6){
                      echo "Compró";
                    }else if($pedido['est'] == 7) {
                      echo "Cotizado";
                    }
                    ?></td>
                  <td class="text-right"><?= $pedido['usu_city'] ?></td>
        ...
        <div class="col-md-6">
          <div class="tile">
            <div class="container-title">
              <h3 class="tile-title">Ciudades mas cotizadas</h3>
              <div class="dflex">
