...
<html lang="es">
  <head>
    <meta charset="utf-8">
    <meta name="description" content="Tienda virtual Dimasur">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Luis Cruz Sanchez">
    <meta name="theme-color" content="#248240">
    <link rel="shortcut icon" href="<?= media();?>/images/logov2.png">
  ...
  <body class="app sidebar-mini">
    ...
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="<?= base_url(); ?>/dashboard">Dimanet</a>
