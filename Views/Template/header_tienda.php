...
<!--===============================================================================================-->	
	<link rel="icon" type="image/png" href="<?= media() ?>/tienda/images/logov2.png"/>
<!--===============================================================================================-->
	...
	<header>
			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					...
					<div class="right-top-bar flex-w h-full">
						...
						?>
						<a href="<?= base_url() ?>/usuarios" class="flex-c-m trans-04 p-lr-25">
							Mi cuenta
						</a>
						<?php } 
							if(isset($_SESSION['login'])){
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<a href="<?= base_url(); ?>" class="logo">
						<img src="<?= media() ?>/tienda/images/logov2.png" alt="Tienda Virtual">
					</a>
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li>
								...
								<a href="<?= base_url(); ?>tienda/categoria/1/tecnologia">Tecnología</a>
							</li>

							<li>
								<!-- <a href="<?= base_url(); ?>carrito">Carrito</a> -->
								<a href="<?= base_url(); ?>">Maquinaria</a>
								<ul class="sub-menu">
									<li>
									<a href="<?= base_url(); ?>tienda/categoria/2/maquinaria-agricola">Agrícola</a>
									</li>
									<li>
									<a href="<?= base_url(); ?>tienda/categoria/3/construccion">Construcción</a>
									</li>
									<li>
									<a href="<?= base_url(); ?>tienda/categoria/4/jardin-y-golf">Jardinería y Golf</a>
									</li>
								</ul>
							...
							<li>
								<a href="<?= base_url(); ?>nosotros">Refacciones</a>
							</li>

							<li>
								<a href="<?= base_url(); ?>sucursales">Servicio</a>
							</li>
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="<?= base_url(); ?>"><img src="<?= media() ?>/tienda/images/logov2.png" alt="Tienda Virtual"></a>
			</div>
