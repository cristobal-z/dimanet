    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <?php } ?>
            ...
            <?php if(!empty($_SESSION['permisos'][10]['r']) || !empty($_SESSION['permisos'][11]['r']) || !empty($_SESSION['permisos'][12]['r'])){ ?>

        <li class="treeview">
            <a class="app-menu__item" href="#" data-toggle="treeview">
                <i class="app-menu__icon fa fa-envelope-open" aria-hidden="true"></i>
                <span class="app-menu__label">Leads</span>
                <i class="treeview-indicator fa fa-angle-right"></i>
            </a>
            <ul class="treeview-menu">
                <?php if(!empty($_SESSION['permisos'][10]['r'])){ ?>
                <li><a class="treeview-item" href="<?= base_url(); ?>/dji"><i class="icon fa fa-circle-o"></i> DJI</a></li>
                <?php } ?>
                <?php if(!empty($_SESSION['permisos'][11]['r'])){ ?>
                <li><a class="treeview-item" href="<?= base_url(); ?>/agricola"><i class="icon fa fa-circle-o"></i> Agrícola</a></li>
                <?php } ?>
                <?php if(!empty($_SESSION['permisos'][12]['r'])){ ?>
                <li><a class="treeview-item" href="<?= base_url(); ?>/construccion"><i class="icon fa fa-circle-o"></i> Construcción</a></li>
                <?php } ?>
                <?php if(!empty($_SESSION['permisos'][13]['r'])){ ?>
                <li><a class="treeview-item" href="<?= base_url(); ?>/refacciones"><i class="icon fa fa-circle-o"></i> Refacciones</a></li>
                <?php } ?>
