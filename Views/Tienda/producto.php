						...
						<div class="p-t-33">
							<div class="flex-w flex-r-m p-b-10">
								<div class="size-204 flex-w flex-m respon6-next">
									...
									<button onClick="nuevo()" id="buttondron" class="flex-c-m stext-101 cl0 size-101 bg10 bor1 hov-btn1 p-lr-15 trans-04">
										Cotizar Equipo
									</button>
								</div>
							</div>	
        ...
        <div class="modal-content">
            <form method="post" id="usuario_form">
                <div class="modal-header">
                    <h5 id="lbltitulo" class="modal-title uppercase text-center"></h5>
                ...
                <div class="modal-body">
					...
					<div class="form-group selectivo">
                        <label>Maquina</label>
                        <input type="text" name="usu_maq" id="usu_maq" class="form-control" value="<?= $arrProducto['nombre']; ?>" >
                    </div>

                    <div class="form-group">
                        <label>Nombre</label>
                        <input type="text" name="usu_nom" id="usu_nom" class="form-control" placeholder="">
                    </div>
                    <div class="form-group">
                        <label>Correo electrónico</label>
                        <input type="email"  name="usu_correo" id="usu_correo" class="form-control" placeholder="">
                    </div>
                    <div class="form-group">
                        <label>Celular</label>
                        <input type="text" name="usu_num" id="usu_num" class="form-control" placeholder="">
                    </div>
                    <div class="form-group">
                        <label>Ciudad</label>
                        <input type="text" id="usu_city" name="usu_city" class="form-control" placeholder="">
                    </div>
                    <div class="form-group">
                        <label>Tipo de cultivo y número de hectareas</label>
                        <textarea id="usu_cultivo" name="usu_cultivo" class="form-control" rows="3"></textarea>
                    </div>
                </div>
				...
				<input type="hidden" name="_next" value="http://www.dimasur.mx">
